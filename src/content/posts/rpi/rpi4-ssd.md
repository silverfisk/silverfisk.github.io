...
In this case the USB drive name is `sda` and `mmcblk0` is the SD card. If you're unsure, unplug the USB drive and plug it in again so you don't accidentally overwrite your SD card.
...
![Step1](/images/rpi4-stp1.png)
![Step2](/images/rpi4-stp2.png)
![Step3](/images/rpi4-stp3.png)
![Step4](/images/rpi4-stp4.png)
