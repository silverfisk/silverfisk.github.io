...
categories: []
thumbnail: "/images/rpi-logo.png"
---


Disk intensive applications such as kubernetes can run on Raspberry Pi 4, but you need to [migrate from the SD card to an SSD drive](/posts/rpi/rpi4-ssd/).
Trust me, you don't want to run this from your SD card. I tried...

Warning: I have noted down the steps taken, there may be some additional steps you need to take to get everything working. If so let me know through [GitHub](https://github.com/silverfisk/silverfisk.github.io/blob/main/content/posts/k8s/rpi4-k3s.md)
